...
class ArcadeAppHostSyncManager : public IHostSyncManager
{
private:
    ULONG m_ulRefCount;
...
public:
    ArcadeAppHostSyncManager();
    virtual ~ArcadeAppHostSyncManager();

private:
    ArcadeAppHostSyncManager(const ArcadeAppHostSyncManager&);
    ArcadeAppHostSyncManager& operator = (const ArcadeAppHostSyncManager&);
