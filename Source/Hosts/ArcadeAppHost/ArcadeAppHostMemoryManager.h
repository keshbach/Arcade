...
class ArcadeAppHostMemoryManager : public IHostMemoryManager
{
private:
    ULONG m_ulRefCount;
...
public:
    ArcadeAppHostMemoryManager();
    virtual ~ArcadeAppHostMemoryManager();

private:
    ArcadeAppHostMemoryManager(const ArcadeAppHostMemoryManager&);
    ArcadeAppHostMemoryManager& operator = (const ArcadeAppHostMemoryManager&);
